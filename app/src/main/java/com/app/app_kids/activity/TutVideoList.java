...
public class TutVideoList extends AppCompatActivity {

    RecyclerView recyclerView;
    TutModelAdapter adapter;
   ...
   // AdView mAdView;
    ...
    private void initRecyclerView()
    {
        ...
        recyclerView=findViewById(R.id.rvTut);
    ...
    private void setData() {
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("Tutorial");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new TutModelAdapter(TutVideoList.this,modelClasses);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(TutVideoList.this, "error:"+error.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
